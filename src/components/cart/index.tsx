            ...
            <div
                ...
                <div className="p-4 bg-white rounded-lg shadow-4xl">
                    ...
                    <div className="flex flex-col mb-6">
                        <h2 className="text-lg flex items-center justify-center gap-2">Shopping Cart</h2>
                    </div>
                    ...
                    <button type="button" className="w-full bg-primary text-white p-3 text-md rounded-md">Checkout</button>
                </div>
            </div>
            {isCartOpen && (
                <div
