...
const Login: React.FC<LoginMenuProps> = ({ isLoginOpen, toggleLoginMenu }) => {
    const { isAuthenticated, loading, username, login, logout } = useAuth();
                    ...
                    {!isAuthenticated ?
                        <>
                            ...
                            <form method="post" action="#" className="flex flex-col w-full">
                                ...
                                {response &&
                                    <div className={`mb-4 text-xs rounded-md p-1.5 ${success ? 'text-green-600 bg-green-50' : 'text-red-600 bg-red-50'}`}>
                                        {response}
                                    </div>}
                                {loading &&
                                    <div className='mb-4'>
                        ...
                        : <div className="flex flex-col text-center items-center justify-center">
                            ...
                            <h1 className='mt-4 font-bold'>Welcome {username}!</h1>
